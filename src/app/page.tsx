...
export default function Page() {
  ...
  // Deliberately no loading gate here: token defaults to null, so the
  // server-rendered HTML (and first client paint) is always Landing's real
  // markup — required so crawlers see actual content instead of a spinner.
  // This effect then swaps in Dashboard a frame later if a session exists.
  useEffect(() => {
